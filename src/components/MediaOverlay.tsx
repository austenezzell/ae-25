...
export default function MediaOverlay({ 
  ...
  useEffect(() => {
    if (onBackgroundColorChange && mediaItems[currentIndex].backgroundColor) {
      onBackgroundColorChange(mediaItems[currentIndex].backgroundColor);
    }
  }, [currentIndex, mediaItems, onBackgroundColorChange]);
